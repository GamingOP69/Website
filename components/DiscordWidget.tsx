  ...
  return (
    <div className="surface space-y-4 p-5">
      ...
      <a
        ...
        className="flex w-full items-center justify-center gap-2 rounded-md bg-[#5865F2] py-2.5 text-sm font-semibold text-white no-underline transition-colors hover:bg-[#4752c4]"
      >
